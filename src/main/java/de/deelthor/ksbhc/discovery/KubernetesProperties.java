...
public final class KubernetesProperties {
    ...
    /**
     * <p>Configuration key: <tt>service-names</tt></p>
     * Defines the service names of the POD to lookup through the Service Discovery REST API of Kubernetes.
     */
    public static final PropertyDefinition SERVICE_NAMES = property("service-names", STRING);
